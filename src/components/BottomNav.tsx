...
export default function BottomNav({ activeTab, onTabChange }: BottomNavProps) {
  const tabs = [
    ...
    { id: 'groups' as const, label: 'Groups', icon: FolderIcon },
    { id: 'settings' as const, label: 'Settings', icon: SettingsIcon },
  ]

  return (
    <nav className="fixed bottom-0 left-0 right-0 z-[120] border-t isolate bg-[#ffffff] dark:bg-[#262017] pb-safe">
