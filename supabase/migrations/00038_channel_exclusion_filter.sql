-- ============================================================================
-- Migration 00038: Add Channel Exclusion Filter
--
-- Adds ability to exclude specific channels from feed results
-- Users can now filter to either INCLUDE or EXCLUDE selected channels
-- ============================================================================
...
-- Create updated function with exclude_channel_ids parameter
...
COMMENT ON FUNCTION get_feed IS 'Get video feed for user with support for including or excluding specific channels';
