-- Add channel_ids filter parameter to get_feed function

-- Drop existing function first (required when changing parameters)
DROP FUNCTION IF EXISTS get_feed(uuid,uuid,uuid[],text,boolean,boolean,integer,integer,timestamptz,timestamptz,boolean,boolean,integer,integer);
